...
namespace InventoryAppEFCore.DataLayer
{
    public class InventoryAppEfCoreContext : DbContext
    {
        ...
        [DbFunction]
        public static decimal NetSales(int quantity, decimal list_price, decimal discount) {
            return Math.Round(quantity * list_price * (1 - (discount / 100)),2);
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.HasDbFunction(
                () => NetSales(default(int), default(decimal), default(decimal))
                ).HasSchema("dbo");
