...
namespace InventoryAppEFCore.DataLayer.Migrations
{
    ...
    [Migration("20230105040541_AddVW_Products")]
    partial class AddVW_Products
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InventoryAppEFCore.DataLayer.EfClasses.LineItem", b =>
                {
                    ...
                    b.Property<int>("SelectedProductProductId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SelectedProductProductId");
            ...
            modelBuilder.Entity("InventoryAppEFCore.DataLayer.Views.VW_Product", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InventoryAppEFCore.DataLayer.EfClasses.LineItem", b =>
                {
                    ...
                    b.HasOne("InventoryAppEFCore.DataLayer.EfClasses.Product", "Product")
                        .WithOne("LineItem")
                        .HasForeignKey("InventoryAppEFCore.DataLayer.EfClasses.LineItem", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("InventoryAppEFCore.DataLayer.EfClasses.Product", "SelectedProduct")
                        .WithMany()
                        .HasForeignKey("SelectedProductProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("InventoryAppEFCore.DataLayer.EfClasses.Order", b =>
                {
                    b.HasOne("InventoryAppEFCore.DataLayer.EfClasses.Client", "Client")
                        .WithMany("Orders")
